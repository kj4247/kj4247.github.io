            ...
            return u(t, e), l(t, [{
                ...
                value: function() {
                    var e = this,
                        ...
                        o = t.country,
                        i = t.resolution;
                    return d.default.createElement("div", { className: "app" }, d.default.createElement("header", null, d.default.createElement("div", { className: "center" }, d.default.createElement("div", { className: "logo" }, "AppStore应用图标"), d.default.createElement("div", { className: "description" }, "Get icons from App Store"), d.default.createElement("div", { className: "options" }, "国家: ", d.default.createElement("lable", { onClick: function() { return e.setState({ country: "CN" }) } }, d.default.createElement("input", { name: "store", type: "radio", checked: "CN" === o }), "中国"), d.default.createElement("lable", { onClick: function() { return e.setState({ country: "US" }) } }, d.default.createElement("input", { name: "store", type: "radio", checked: "US" === o }), "美国"), d.default.createElement("lable", { onClick: function() { return e.setState({ country: "JP" }) } }, d.default.createElement("input", { name: "store", type: "radio", checked: "JP" === o }), "日本")), d.default.createElement("div", { className: "options" }, "分辨率: ", d.default.createElement("lable", { onClick: function() { return e.setState({ resolution: 512 }) } }, d.default.createElement("input", {
                        name: "resolution",
                        type: "radio",
                        checked: 512 === i
                    }), "512x512"), d.default.createElement("lable", { onClick: function() { return e.setState({ resolution: 1024 }) } }, d.default.createElement("input", { name: "resolution", type: "radio", checked: 1024 === i }), "1024x1024")), d.default.createElement("div", { className: "search" }, d.default.createElement("input", { className: "search-input", placeholder: "应用名称 / iTunes链接", value: n, onChange: function(t) { return e.setState({ input: t.target.value }) }, onKeyDown: function(t) { return 13 === t.keyCode ? e.search() : "" } }), d.default.createElement("div", { className: "search-button", onClick: this.search }, d.default.createElement("img", { src: y.default, className: "search-icon", alt: "search" }))))), d.default.createElement("main", { className: "results" }, r.map(function(e) { return d.default.createElement(h.default, { key: e.trackId, data: e, resolution: i }) })), d.default.createElement("footer", { className: "footer" }, "", ))
                }
            }]), t
        }(p.Component);
        t.default = g
